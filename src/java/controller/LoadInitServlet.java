...
public class LoadInitServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        String copyright = "copyright is missing.";
        String companyName = "company name is missing";
        String companyEmail = "company email is missing";
        ServletContext context = getServletContext();
        if (context.getInitParameter("copyright") != null || context.getInitParameter("companyname") != null) {
            copyright = context.getInitParameter("copyright");
            companyName = context.getInitParameter("companyname");
            companyEmail = context.getInitParameter("email");
        }
        context.setAttribute("copyright", copyright);
        context.setAttribute("companyname", companyName);
        context.setAttribute("email", companyEmail);
     }
