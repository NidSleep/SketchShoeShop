...
public class FindDeleteUser extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try(PrintWriter out = response.getWriter()) {
            String userid = request.getParameter("delUser");
            ...
            utx.begin();
            List<Loginuser> delList = loginService.findUserById(userid);
            utx.commit();

            if (!delList.isEmpty()) {

                Loginuser checkUserId = delList.get(0);
