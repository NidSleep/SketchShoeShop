...
public class UpdateOrder extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            utx.begin();
            boolean success = ordersService.updateOrder(orderId, status);
            utx.commit();
            ...
            if (success == false) {
                ...
                out.println("<script>let myModal = new bootstrap.Modal(document.getElementById('UnsuccessUpdOrder'), {});myModal.show();</script>");
            } else {
                RequestDispatcher rd = request.getRequestDispatcher("ordersAction.jsp");
                rd.include(request, response);
                out.println("<script>let myModal = new bootstrap.Modal(document.getElementById('SuccessUpdOrder'), {});myModal.show();</script>");   
            }
