<%-- 
    Document   : UpdateStaConfirm
    Created on : May 8, 2023, 11:25:50 PM
    Author     : user
--%>
...
<html>
    <head>
        ...
        <title>Update Staff Confirm</title>
    ...
    <body>
        ...
        <h3>
            <%
                List<Staff> updaList = (List) session.getAttribute("updaList");
