<%-- 
    Document   : SearchItem
    Created on : May 3, 2023, 1:05:59 PM
    Author     : User
--%>
...
<html>
    <head>
        ...
        <!-- Favicon -->
        <link rel="icon" type="image/png" href="./src/img2/logo.png" />
    ...
    <body>
        <div id="blur">
                ...
                <div class="bg-primary mb-4" style="background-color: #3e3e3e !important">
                    <div class="container py-4">
                        <h3 class="text-white mt-2">Search Result</h3>
                    </div>
                </div>
                <!-- Heading -->
            </header>
            ...
            <!-- sidebar + content -->
            <section class="" id="itemSection" style="min-height: 600px">
                <div class="container">
                    <div class="row">
                        <!-- sidebar -->
                        <div class="col-lg-3">
                        ...
                        <div class="col-lg-9">
                            <%
                                List<Item> itemSearchList = (List) session.getAttribute("itemSearchList");
                            %>
                            <div class="row">
                                    ...
                                    <div class="card w-100 my-2 shadow-2-strong">
                                        ...
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <div class="d-flex flex-row">
                                                <h3 id="dataprice<%=item.getItemid()%>" class="mb-1 me-1" data-price="<%=item.getItemprice()%>">RM<%= item.getItemprice()%>0</h3>
                                            </div>
        ...
        <div class="popupItem" id="popupItem" style="border-radius: 40px;">
            <div>
                <button id="closebtn" onclick="closeItem()">X</button>
            </div>
