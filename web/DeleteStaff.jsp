<%-- 
    ...
    Created on : May 9, 2023, 12:05:33 AM
    Author     : user
--%>
...
<body>
    <%
        List<Staff> deleteList = (List) session.getAttribute("deleteList");
    %>

    <div class="search-form">
        <div class="title"><b>Delete User</b></div>
        <form method="post" action="FindDeleteStaff">
            <div class="input-box">
                <input type="text" id="delStaff" name="delStaff" placeholder="Enter staff id" maxlength="6" required>
                <input type="submit" id="delete" name="delete" value="Search User">
