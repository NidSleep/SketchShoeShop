<%-- 
    Document   : DeleteStaffConfirm
    Created on : May 9, 2023, 12:34:39 AM
    Author     : user
--%>
...
<html>
    ...
    <body>
        ...
        <h2>
            ...
            <%= session.getAttribute("staffId")%> 's Information deleted successfully.
            <% } else { %>
            <i class="bi bi-exclamation-circle-fill text-danger"></i>
            Error: Unable to delete staff information.
            <% }%>
        </h2>
        <br><br><br><br><br><br><br><br>
    </body>
